...
void find_duplicate_elements(int arr[], int n, int *total_duplicates, int *most_repeating_element) {
...
int main() {
    ...
    find_duplicate_elements(arr, n, &total_duplicates, &most_repeating_element);
